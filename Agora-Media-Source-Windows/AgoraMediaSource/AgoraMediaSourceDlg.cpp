...
BEGIN_MESSAGE_MAP(CAgoraMediaSourceDlg, CDialogEx)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_NCHITTEST()
	ON_MESSAGE(WM_GOBACK, &CAgoraMediaSourceDlg::OnBackPage)
...
LRESULT CAgoraMediaSourceDlg::OnBackPage(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CAgoraMediaSourceDlg::OnNextPage(WPARAM wParam, LPARAM lParam)
{
	m_lpCurDialog->ShowWindow(SW_HIDE);
