...
#define MAX_AUDIO_SAMPLE_SIZE (48000*2*2 + AUDIO_CALLBACK_TIMES*sizeof(int64_t))//sampleRate*sizeof(16bit)*channel+ AUDIO_CALLBACK_TIMES*sizeof(timestamp)=max_s
class CircleBuffer
{
private:
	BYTE* m_pBuffer;
